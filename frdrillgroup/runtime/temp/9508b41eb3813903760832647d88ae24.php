<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:82:"/Users/panliu/Documents/project/qianzhi/addons/cms/view/default1/list_product.html";i:1654608097;s:81:"/Users/panliu/Documents/project/qianzhi/addons/cms/view/default1/common/meta.html";i:1654271884;s:83:"/Users/panliu/Documents/project/qianzhi/addons/cms/view/default1/common/header.html";i:1654618749;s:80:"/Users/panliu/Documents/project/qianzhi/addons/cms/view/default1/common/mbx.html";i:1654685697;s:83:"/Users/panliu/Documents/project/qianzhi/addons/cms/view/default1/common/footer.html";i:1654524000;s:83:"/Users/panliu/Documents/project/qianzhi/addons/cms/view/default1/common/script.html";i:1654003873;}*/ ?>
...
<!--                  <?php endif; ?>-->
          ...
          <ul class="nav navbar-nav pull-right menu-list">
              <?php $__hzQMC2KPOb__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20"]); if(is_array($__hzQMC2KPOb__) || $__hzQMC2KPOb__ instanceof \think\Collection || $__hzQMC2KPOb__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__hzQMC2KPOb__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
              <li>
              ...
              <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__hzQMC2KPOb__; ?>
...
<!--                        <?php $__ZHxGMSVDcL__ = \addons\cms\model\Channel::getBreadcrumb($__CHANNEL__??[], $__ARCHIVES__??[], $__TAGS__??[], $__PAGE__??[], $__DIYFORM__??[]); if(is_array($__ZHxGMSVDcL__) || $__ZHxGMSVDcL__ instanceof \think\Collection || $__ZHxGMSVDcL__ instanceof \think\Paginator): $k = 0; $__LIST__ = $__ZHxGMSVDcL__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;?>-->
<!--							<?php if($k>1): ?>» <?php endif; ?><a title="<?php echo $item['name']; ?>" href="<?php echo $item['url']; ?>"><?php echo $item['name']; ?></a>-->
<!--        				<?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__ZHxGMSVDcL__; ?>-->
<!--        				</div>-->
<!--                 -->
<!--                    -->
<!--		 	</div>-->
...
<div id="header-banner" class="product-header" style="background: url(<?php echo $__CHANNEL__['image']; ?>)">
	<div class="container relative" style="height: 100%;">
		<div class="product-header-content">
			...
			<div>
				<span class="glyphicon glyphicon-home"></span>
				<?php $__zxS6ZapKC3__ = \addons\cms\model\Channel::getBreadcrumb($__CHANNEL__??[], $__ARCHIVES__??[], $__TAGS__??[], $__PAGE__??[], $__DIYFORM__??[]); if(is_array($__zxS6ZapKC3__) || $__zxS6ZapKC3__ instanceof \think\Collection || $__zxS6ZapKC3__ instanceof \think\Paginator): $k = 0; $__LIST__ = $__zxS6ZapKC3__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;if($k>1): ?>» <?php endif; ?><span><a title="<?php echo $item['name']; ?>" href="<?php echo $item['url']; ?>" style="color: #ffffff"><?php echo $item['name']; ?></a></span>
				<?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__zxS6ZapKC3__; ?>
			</div>
		</div>
	</div>
</div>
	...
	<div class="container card-item">
		<div class="row" id="productList">
			<script id="productListTemplate" type="text/html">
				<?php $__0iFah5MG1O__ = $__PAGELIST__; if(is_array($__0iFah5MG1O__) || $__0iFah5MG1O__ instanceof \think\Collection || $__0iFah5MG1O__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__0iFah5MG1O__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
				...
				<?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__0iFah5MG1O__; ?>
			</script>
		</div>
      ...
      <div class="container">
        <div class="row d-flex" style="flex-wrap: wrap;">
          <div class="col-md-3 col-sm-6 col-xs-12">
            ...
            <?php $__weEkI6YoP7__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"contact-qianzhi","orderby"=>"id","orderway"=>"asc"]); if(is_array($__weEkI6YoP7__) || $__weEkI6YoP7__ instanceof \think\Collection || $__weEkI6YoP7__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__weEkI6YoP7__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;if($block['id'] != 54): ?>
            <p class="zh-list">
              <span class="icon glyphicon glyphicon-<?php echo $block['image']; ?>"></span>
              <span><?php echo str_replace(["<p>","</p>"], "", $block['content']); ?></span>
            </p>
            <?php endif; endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__weEkI6YoP7__; ?>

          </div>
          <div class="col-md-2 col-sm-6 col-xs-12">
            <span class="title">Product</span>
            <?php $__Tmt50fMhgD__ = \addons\cms\model\Channel::getChannelList(["id"=>"channel","type"=>"son","typeid"=>"44","condition"=>"1=cpindex","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__Tmt50fMhgD__) || $__Tmt50fMhgD__ instanceof \think\Collection || $__Tmt50fMhgD__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__Tmt50fMhgD__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
              <p><?php echo $channel['name']; ?></p>
            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__Tmt50fMhgD__; ?>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12">
            <span class="title">Recent post</span>
            <?php $__XuR8cV5Hkt__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","flag"=>"index","model"=>"10","row"=>"10","orderby"=>"updatetime","addon"=>"content"]); if(is_array($__XuR8cV5Hkt__) || $__XuR8cV5Hkt__ instanceof \think\Collection || $__XuR8cV5Hkt__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__XuR8cV5Hkt__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
              <p>
              <div class="media">
            ...
            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__XuR8cV5Hkt__; ?>
          </div>
          <div class="col-md-3 col-sm-6 col-xs-12">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 col-sm-6 text-right communications">
            <?php $__FxorzlA3qb__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"mt","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__FxorzlA3qb__) || $__FxorzlA3qb__ instanceof \think\Collection || $__FxorzlA3qb__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__FxorzlA3qb__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
...
<!--              <i class="ico <?php echo $block['image']; ?>"></i>-->
            ...
            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__FxorzlA3qb__; ?>
          </div>
        </div>
      </div>
    </div>
